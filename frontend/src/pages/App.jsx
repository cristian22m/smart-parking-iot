...
export default function App() {
  // Eliminamos handleEntrada y handleSalida del destructuring
  const { plazas, timings, now, libres, ocupados } = usePlazas();
          ...
          <div className="flex-1 flex justify-center w-full">
            <div className="flex flex-col items-center bg-gray-700 p-6 lg:p-8 rounded-lg shadow-inner">
              <div className="flex items-center justify-center gap-4 lg:gap-6">
                {/* Ya no pasamos los handlers a los hijos */}
                <LeftPlaces plazas={plazas} timings={timings} now={now} />
                <Center />
                <RightPlaces plazas={plazas} timings={timings} now={now} />
              </div>
              <BottomPlaces plazas={plazas} timings={timings} now={now} />
            </div>
          </div>
